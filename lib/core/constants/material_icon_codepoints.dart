...
// Ported from admin web src/constants/flutterMaterialIconCodepoints.ts so
// the app can render ANY Material icon the admin picks, by codepoint.
// Regenerate (keeping both sides in sync) when the project upgrades Flutter.
//
// Used as IconData(codepoint, fontFamily: 'MaterialIcons'); the app MUST be
// built with --no-tree-shake-icons so these dynamic glyphs are not stripped.
