...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // opened via IncomingRequestDetailsLoader, which fetches the real data
      // from GET /api/auth/worker/request/<offer_id>/ — do not point `home:`
      // at IncomingRequestDetailsScreen with hardcoded preview data again, as
      // that bypasses login and the API.
